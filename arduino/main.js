    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            ...
            if (AMBIENTE == 'producao') {
                ...
                const connStr = "Server=svr-1adsb-grupo7.database.windows.net;Database=grupo7;User Id=greenhouse1_datawriter;Password=#Gfgrupo7;";
...
// CREATE USER [greenhouse1_datawriter]
// WITH PASSWORD = '#Gf_senhaParaAPI',
// DEFAULT_SCHEMA = dbo;

// EXEC sys.sp_addrolemember @rolename = N'db_datawriter', @membername = N'greenhouse1_datawriter'
